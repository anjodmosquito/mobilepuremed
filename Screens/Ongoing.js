    ...
    <View style={styles.container}>
      ...
      <View style={styles.timelineContainer}>
        <View style={styles.timelineItem}>
          ...
          <Image source={require('../assets/packing.png')} style={styles.timelineImage} />
          <Text style={styles.timelineText}>We are packing your items...</Text>
        </View>
        <View style={styles.timelineItem}>
          <Icon name="check-circle" style={styles.timelineIconActive} />
          <Image source={require('../assets/counter.png')} style={styles.timelineImage} />
          <Text style={styles.timelineText}>
            Your reservation is now over the counter. Please claim within 24hrs...
          </Text>
        </View>
        <View style={styles.timelineItem}>
          <Icon name="circle-thin" style={styles.timelineIcon} />
